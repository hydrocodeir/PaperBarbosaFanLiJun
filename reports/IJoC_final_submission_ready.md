...
The limitations of the study should be stated explicitly. The station network is finite, the strongest tails remain the most uncertain part of the distribution, and the driver analysis is intentionally simple. Bootstrap inference is more defensible than asymptotic analytic intervals for the focal tails, but even bootstrap intervals for short annual series should still be interpreted as uncertainty summaries rather than exact small-sample coverage guarantees. Interpolated surfaces are used as visualization tools rather than primary inferential products, and the station markers in the quantile-map figures indicate analytic rather than bootstrap significance. The period split is informative but still descriptive and does not amount to formal breakpoint attribution. These limitations do not invalidate the main conclusions, but they do define the appropriate scope of interpretation.
